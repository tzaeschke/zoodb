 ...
 */
public final class PrimLongMapZWeakTest extends PrimLongMapTest {

	@Override
	protected PrimLongMap<String> createMap() {
		return new PrimLongMapZWeak<String>();
	}
    ...
    public void testLargeWithGC() {
    	...
    	PrimLongMapZWeak<String> map = new PrimLongMapZWeak<>();
    	for (int i = 0; i < N; i++) {
	...
	public void bruteForce() {
		int N = 10000;
		int N1 = 10;
		PrimLongMapZWeak<Long> map = new PrimLongMapZWeak<>();
		//Write 1st half
		for (int i = 0; i < N; i++) {
