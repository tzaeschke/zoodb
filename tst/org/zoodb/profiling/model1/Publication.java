...
//    private String conferenceIssue;	
	...
	public void addTargetA(Author author) {
		activateWrite("targetA");
		if (this.targetA == null) {
			throw new IllegalStateException("Association targetA is not initialized yet. " +
					"Please use setTargetA(List<Author>) instead");
		}
		if(author != null){
	...
	public void addTargetT(Tags tags) {
		activateWrite("targetT");
		if (this.targetT == null) {
			throw new IllegalStateException( "Association targetT is not initialized yet. " +
					"Please use setTargetT(List<Tags>) instead");
		}
		if(tags != null){
