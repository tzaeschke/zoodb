...
public class ConferenceSeries extends PersistenceCapableImpl     {	
	 ...
	 * @throws Exception	 
	 */
	public void addConferences(Conference conference) throws Exception{
		activateWrite("conferences");
		if (this.conferences == null) {
			throw new Exception(
					"Association conferences is not initialized yet. Please use setConferences(List<Conference>) instead");
		}
		if(conference != null){
