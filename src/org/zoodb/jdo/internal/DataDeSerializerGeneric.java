 ...
 */
public class DataDeSerializerGeneric {
    ...
    public DataDeSerializerGeneric(ObjectReader in, AbstractCache cache, Node node) {
        this.in = in;
        this.cache = cache;
        this.node = node;
    }
     ...
     */
    public GenericObject readObject(int page, int offs, boolean skipIfCached) {
...
//    	
//    	
    	GenericObject pObj = getInstance(clsDef, oid, pc);

        return readObjPrivate(pObj, oid, clsDef);
    }
    
    
    public GenericObject readObject(GenericObject pc, int page, int offs) {
        long clsOid = in.startReading(page, offs);
    ...
    private GenericObject readObjPrivate(GenericObject pObj, long oid, ZooClassDef clsDef) {
    ...
    private final Object deserializeFields1(GenericObject obj, ZooClassDef clsDef) {
    	ZooFieldDef f1 = null;
        Object deObj = null;
        try {
            //Read fields
    ...
    private final Object deserializeFields2(GenericObject obj, ZooClassDef clsDef) {
        ZooFieldDef f1 = null;
        Object deObj = null;
        try {
            //Read fields
            ...
            throw new RuntimeException("Field: " + f1.getTypeName() + " " + f1.getName(), e);
        } catch (IllegalAccessException e) {
            throw new RuntimeException(e);
        } catch (SecurityException e) {
            throw new RuntimeException(e);
