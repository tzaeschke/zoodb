...
public class PerfIterator {
	...
	public void run() {
		...
		PagedUniqueLongLong ull = 
			new PagedUniqueLongLong(new PageAccessFileInMemory(ZooConfig.getFilePageSize(), null));
		PagedLongLong ll = 
			new PagedLongLong(new PageAccessFileInMemory(ZooConfig.getFilePageSize(), null));
