...
public class ClassMergeCandidate {
	...
	public boolean evaluate() {
		...
		double epsilon = 0.0;
		double costTerm1 = ProfilingConfig.CMA_ALPHA*mergeeWOMasterRead*1.0; //replace 1.0 with avg_sizeof(classA)
		double costTerm2 = ProfilingConfig.CMA_BETA*getMasterWOMergeeRead()*1.0; // replacte 1.0 with avg_sizeof(classB)
